# Улучшенный промпт для генерации статей блога

## Обновленный метод buildPrompt
...
## Основные улучшения промпта:

1. ✅ **Добавлен контекст проекта** - информация о сайте, услугах, географии
2. ✅ **Расширена SEO оптимизация** - детальные требования по ключевым словам, заголовкам, мета-описаниям
3. ✅ **Географические ключевые слова** - обязательные упоминания городов Казахстана
4. ✅ **Внутренние ссылки** - требования по добавлению ссылок на услуги
5. ✅ **Ключевые слова по услугам** - список ключевых слов для каждой услуги
6. ✅ **Структура контента** - детальные требования по структуре статьи
7. ✅ **Категории** - список доступных категорий
8. ✅ **Примеры ключевых слов** - примеры для разных тем
9. ✅ **Требования к длине** - увеличен до 2000-3000 слов для лучшего SEO
10. ✅ **Плотность ключевых слов** - указана оптимальная плотность (1-2%)
